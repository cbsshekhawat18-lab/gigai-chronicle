...
- 5536b71: M3 — Truth on Disk: Chronicle Store layer 1. `EventLog` with exactly three
...
- 2fa51ae: M5 — The Only Door: the Event Engine. Four-stage pipeline (validate → redact
